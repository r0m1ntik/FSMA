...
public class AttentePremiereOffre extends Behaviour {
    ...
    public AttentePremiereOffre(Seller sellerAgent, Model.Seller sellerModel) {
        super();
    ...
    public boolean done() {
        if (this.sellerModel.is_etatEnchereTermine() && this.sellerModel.get_paiementAcheteur() == 0){
            ...
            // this.sellerAgent.addBehaviour(new AttenteSecondeOffre(this.sellerAgent, this.sellerModel)); TODO
            return true;
        } else return false;
    }
}
